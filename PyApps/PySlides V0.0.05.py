...
while not done:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            #print(event.key) #used for key input(char)
            ...
            #click inside box:
            #input text, set [x,y] to boxpos 01 and 02.
