...
points = [[math.log(1),math.log(1)],
          [math.log(2),math.log(1.414)],
          [math.log(3),math.log(1.732)],
          [math.log(4),math.log(2.000)],
          [math.log(5),math.log(2.236)],
          [math.log(6),math.log(2.449)]]
var_input(points)
