...
class PyNotes:
    ...
    def search(self, string='',
        ...
        # Printing
##        first_timestamp = self.text.rfind('TIMESTAMPSTR',
##                                          self.lastIndex)
##        last_timestamp = self.text.find('TIMESTAMPSTR',
##                                        self.lastIndex)
##        if display_section:
##            print('\n\t\t------------section------------\n')
##            print(self.text[first_timestamp:self.lastIndex], end='')
##            print(">>>>> " +\
##                  self.text[self.lastIndex:self.lastIndex+len(string)] +\
##                  " <<<<<", end='')
##            print(self.text[self.lastIndex+len(string):last_timestamp])
##            print('\n\t\t------------section------------\n')
