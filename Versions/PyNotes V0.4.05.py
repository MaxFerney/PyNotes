...
##                        bp = temp_bp #this breaks it
        ...
        if backup:
            #  put it in a folder based on current path?..
            #   ..eventually
...
def notes():
    ...
    #Math
    if is_in_time(['mon', 'wed', 'fri'],'11:00','12:15',20):
        MATH = True
    #History
    ...
    #Computer Science
        ...
        CSCI = True
    #Critical Writing
    elif is_in_time(['mon', 'wed'],'15:30','16:45',20):
        CRTW = True

    #Start Notes
    if MATH:
        quickstart('MATH', True, 'Math201.txt', '12:15')
    elif HIST:
        quickstart('HIST', True, 'Hist111.txt', '18:15')
    elif CSCI:
        quickstart('CSCI', True, 'Csci207.txt', '13:45')
    elif CRTW:
        quickstart('CRTW', True, 'Crtw201.txt', '16:45')
    else:
