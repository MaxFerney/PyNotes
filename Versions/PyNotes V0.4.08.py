...
def notes():
    ...
    if is_in_time(['mon','wed','fri'],'11:00','12:15',20):
        quickstart('CALC', True, 'math201_3.txt', '12:15')
    #Computer Science
    elif is_in_time(['mon', 'wed'],'14:00','15:15',20):
        quickstart('CSCI', True, 'csci211.txt', '15:15')
    #Web Applications
    elif is_in_time(['tue', 'thu'],'15:30','18:15',20):
        quickstart('DIFD', True, 'difd141.txt', '18:15')
