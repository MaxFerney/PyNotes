...
##        ind_lvl = 0
        ...
        if not system:
            ...
            def Underline(last_string):#pretext/indent, and return them
...
--------------------------------------------------
        ...
        create schedule class (for each item)
...
def notes():
    ...
    #Start Notes
    if MATH:
        quickstart('MATH', True, 'Math101.txt', '10:45')
    elif ECON:
        quickstart('ECON', True, 'Econ103.txt', '15:15')
    elif PHIL:
        quickstart('PHIL', True, 'Phil101.txt', '15:15')
    elif HMXP:
        quickstart('HMXP', True, 'Hmxp102.txt', '18:15')
    else:
