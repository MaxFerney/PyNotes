...
##                        bp = temp_bp #this breaks it
    ...
    def VersionLog(self):
        ...
        0.3.08.1(Built during Summer 2016)
        Changes in schedule, possibly make a function
            to save the schedule or set the schedule

        0.3.08.2 (planned)
        Get Paint working as well as getting algebra
            functions working,
        Create Graph Program using specific points
...
def notes():
    ...
    #Math
    if is_in_time(['mon', 'tue', 'wed', 'thu'],'10:30','11:30',20):
        MATH = True

    #Start Notes
    if MATH:
        quickstart('MATH110', True, 'Math Notes.txt')
    else:
