...
##                        pretext = pretext[:-lenI] + bp
                    ...
                    #underline
                        ...
                        pretext = ''
                        var=Underline(last_string_array[-1])
                        string = var[0]
...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
        ...
        -this will have a multi-tiered "PyApps"
            -PY APPS
            -will include slides, notes, paint, outline
...
def notes():
    ...
    #Calculus
    if is_in_time(['mon','wed','fri'],'09:30','10:45',20):
        quickstart('CALC', True, 'math201_2.txt', '10:45')
    #Computer Science
    elif is_in_time(['mon', 'wed'],'11:00','13:20',10):
        quickstart('CSCI', True, 'csci208.txt', '13:20')
    #Critical Writing
    elif is_in_time(['tue', 'thu'],'12:30','13:45',20):
        quickstart('CRTW', True, 'crtw201_2.txt', '13:45')
    #Discrete Math
    elif is_in_time(['tue', 'thu'],'14:00','15:15',10):
        quickstart('MATH', True, 'math261.txt', '15:15')
