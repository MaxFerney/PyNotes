...
##            highlightPretext = ''
        ...
        def open_file(return_value=False):
            with open(file) as f:
                t = f.read()
            f.close()
            if return_value:
...
##                key_commands.append(u)
            ...
            to quicksave file: type 'AUTOSAVE'
            ...
            def tag_string(system=False, tagstart='blank', tagend='blank'):
                # Inputs
                if not system:
...
##                t = open_file(True)
            ...
            def while_loop(looping=False, t=''):
##                bp = v['bp']
##                lenI = v['lenI']
##                width = v['width']
##                coding = v['coding']
##                tagging = v['tagging']
##                taggingPretext = v['taggingPretext']
##                delete_last_line = v['delete_last_line']
##                last_string = v['last_string']
##                t = v['t']
##                pretext = v['pretext']
##                ind_lvl = v['ind_lvl']
##                key_commands =v['key_commands']
    ...
    ##                        pretext = highlightPretext
                        ...
                        elif string == 'AUTOSAVE':
                            Auto_Save(t)
##                            save_file()
##                            t = open_file(True)
##                            while_loop(looping=True)
##                            print("FILE SAVED")
##                            break
