...
##        if string_type == '':
    ...
    def EditFile(self, file='', InLoop=False, system=False, message=""):
        ...
        Add a command to entirely delete the above line
            make it easy not to mistake it, or call it accidentally
...
##                key_commands.append(u)
            ...
            to delete last line: type 'DETELE_LAST_LINE'
...
def quickstart(path, system=False, file=None, switching=False):
    global a
