...
def notes():
    ...
    #Philosophy
        ...
        PHIL = True
    #Human Experience
    elif is_in_time(['thu'],'17:00','19:45',20):
        HMXP = True

    #Start Notes
    if MATH:
        quickstart('MATH', True, 'SociologyNotes.txt')
    elif ECON:
        quickstart('WRIT', True, 'SpringSemesterNotes.txt')
    elif PHIL:
        quickstart('PHIL', True, 'MCOM_notes 01.txt')
    elif HMXP:
        quickstart('HMXP', True, 'MCOM_notes 01.txt')
    else:
