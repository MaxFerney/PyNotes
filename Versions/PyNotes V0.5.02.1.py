...
##                        pretext = pretext[:-lenI] + bp
                    ...
                    #codemode
                        ...
                        ind_lvl = 0
                        pretext = ''
                        Coding = True #does this do anything?
                        savedBp = bp
                        bp = '.'
                    #codeexit
                    elif string == 'CODEEXIT':
                        Coding = False #No, it doesnt...
                        pretext = ''
                        bp = savedBp
...
def notes():
    ...
    #Computer Science
    if is_in_time(['mon', 'wed'],'11:00','13:20',20):
        quickstart('CSCI', True, 'csci_208_2.txt', '12:15')
    #Medieval Studies
    elif is_in_time(['tue','thu'],'12:30','13:45',20):
        quickstart('MDST', True, 'mdst_notes.txt', '13:45')
    #Quantatative Methods
    elif is_in_time(['tue', 'thu'],'14:00','15:15',10):
        quickstart('QMTH', True, 'qmth_notes.txt', '15:15')
    #Design Fundamentals
    elif is_in_time(['tue', 'thu'],'16:00','18:15',20):
        quickstart('DESF', True, 'desf_notes.txt', '18:15')



##    #Computer Science
##    if is_in_time(['tue', 'thu'],'9:30','10:45',10):
##        quickstart('CSCI', True, 'csci_243.txt', '10:45')
##    #Digital Information Design
##    elif is_in_time(['tue','thu'],'12:30','14:20',10):
...
##    elif is_in_time(['mon','wed'],'18:30','21:15',10):
